            ...
            <div className="prose max-w-none">
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  By accessing and using Nest Mart & Grocery website, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these terms, please do not use our services.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Prices are subject to change without notice. All prices are in the currency specified on the website.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Delivery times are estimates and not guaranteed. We are not liable for any delays in delivery. Risk of loss and title for products pass to you upon delivery to the carrier.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  The service and its original content, features, and functionality are owned by Nest Mart & Grocery and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  To the maximum extent permitted by law, Nest Mart & Grocery shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the service.
                </p>
              </section>
